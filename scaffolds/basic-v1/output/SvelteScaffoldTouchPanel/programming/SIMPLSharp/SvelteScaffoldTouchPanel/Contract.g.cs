...
namespace SvelteScaffoldTouchPanel
{
    ...
    public class Contract : IContract, IDisposable
    {
        ...
        public SvelteScaffoldTouchPanel.ITouchPanelController TouchPanelController { get { return (SvelteScaffoldTouchPanel.ITouchPanelController)InternalTouchPanelController; } }
        private SvelteScaffoldTouchPanel.TouchPanelController InternalTouchPanelController { get; set; }
        ...
        public Contract(BasicTriListWithSmartObject[] devices)
        {
            ...
            InternalTouchPanelController = new SvelteScaffoldTouchPanel.TouchPanelController(ComponentMediator, 1);
